...
- **LLM_pipeline_project**: one-stop-analysis-shop for processing electronic health records using locally downloaded LLMs. Includes X-shot prompting, RAG and structured output.
